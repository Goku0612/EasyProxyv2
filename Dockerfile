 ...
 *) echo "Unsupported architecture for wgcf/wireproxy:  {WGCF_VERSION}/wgcf_latex
{WGCF_VERSION}_linux_

{wgcf_arch}" -o /usr/local/bin/wgcf; 
 chmod +x /usr/local/bin/wgcf; 
 curl -fL "https://github.com/pufferffish/wireproxy/releases/download/vlatex
{WIREPROXY_VERSION}/wireproxy_linux_

{wireproxy_arch}.tar.gz" -o /tmp/wireproxy.tar.gz; 
